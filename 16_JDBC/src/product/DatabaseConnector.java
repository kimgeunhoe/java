...
public class DatabaseConnector {
	...
	private Connection conn = null; //데이터베이스 접속관현 규격
	private String jdbcDriver = "com.mysql.jdbc.Driver"; //Connector/j에서 제공하는 클래스
	private String jdbcUrl = "jdbc:mysql://localhost/javadb"; //MySQL 프로그램 접근 위치
