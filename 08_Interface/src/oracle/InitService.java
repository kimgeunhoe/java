...
public class InitService {
	...
	private void menuService() {
		while (flag) {
			...
			System.out.println("1.회원가입 2.로그인 3.회원수정 4.회원탈퇴 5.회원리스트 6.회원조회 Etc.종료");
			int svc = sc.nextInt();
			...
			case 3:
				...
				break;
			case 4:
				websvc.resign(getEmailInfo(true));
				break;
			case 5:
				Member[] list = websvc.getList();
				printList(list);
				break;
			case 6:
				Member member = websvc.getMember(getEmailInfo(false));
				printMember(member);
				break;
			default:
				flag = false;
