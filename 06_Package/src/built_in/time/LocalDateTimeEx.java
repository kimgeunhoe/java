...
public class LocalDateTimeEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(curr.substring(curr.indexOf(":")-2, curr.indexOf(":")));
		...
		System.out.println(curr.substring(0, curr.indexOf("T")) + " " + curr.substring(curr.indexOf("T")+1, curr.lastIndexOf(".")));
